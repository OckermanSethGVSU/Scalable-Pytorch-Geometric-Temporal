...
def train(args=None, epochs=None, batch_size=None, allGPU=False, debug=False,
    ...
    if args.dataset == "pems-bay":
        ...
        filepath = "data/speed2GB.h5"
        adj_filepath = "data/all_la_adj.pkl"
        key = "df"
    
    elif args.dataset.lower() == "pems":
        filepath = "data/speed.h5"
    ...
    if args.mode == "dask":
        ...
        # print(x_train.shape, x_val.shape, mean, std)
        # return
    ...
    if args.mode == "dask-index":
        ...
        # print(x_train.shape, x_val.shape, x_test.shape, mean, std)
